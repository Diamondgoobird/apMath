...
public class apMathVariables {
	public static final String MOD_ID = "apmath";
	public static final String MOD_NAME = "Achievement Point Math (AP Math)";
	public static final String VERSION = "1.1";
	public static final String[] things = {"Toggle", "Both"};
	public static String[] stuff = {"Enabled", "yes"};
	public static final String[] options = {"Enabled/Disabled", "yes/no"};
	...
	public static final String CommandName = "apm";
